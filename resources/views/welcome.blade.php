    ...
    <div class="row real" >
        <div class="col-md-8 col-lg-8 bg-light" id="section2">
            <div class="animate__animated animate__backInUp">
                {{--                <img src="https://i.pinimg.com/originals/46/3b/a7/463ba78f99e6b74b24651b61c9338d92.png" alt="" height="95%" width="90%">--}}
                <div id="imgS">
                    <img src="{{asset('vendor/login-v2.72cd8a26.svg')}}" alt="" height="60%" width="60%" style="margin-left: 15%; margin-top: 15%;" />
                </div>
            </div>
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 bg-white" id="section2">
               ...
               <div id="senter">
                   <div class="card-body text-left  mb-0">
                           <h2 style="font-weight: 400">Smart Reyting</h2>
                           <h5>ilmiy va pedagogik faoliyat monitoring axborot tizimi</h5>
