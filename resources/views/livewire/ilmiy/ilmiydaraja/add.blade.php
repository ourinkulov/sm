<div wire:ignore.self class="modal fade bd-example-modal-lg" id="ilmiydarajanitasdiqlash" tabindex="-1" role="dialog" aria-labelledby="ilmiydarajanitasdiqlash" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ilmiydarajanitasdiqlash">Ilmiy darajani tasdiqlash</h5>
...
{{--                    </div>--}}
                      ...
                      <button class="btn btn-primary" wire:click.prevent="ilmiydarajanisaqlash()">Saqlash</button>
