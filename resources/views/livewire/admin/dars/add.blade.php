<div wire:ignore.self class="modal fade bd-example-modal-lg" id="darsupdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Darsni tasdiqlash</h5>
...
{{--                    </div>--}}
                    <div class="form-group">
                        ...
                        <select name="" id="typeid" wire:model="type" class="form-control" onchange="getdarsball()">
                            <option value="0">Tanlang</option>
                            <option value="1">Ochiq dars</option>
                            <option value="2">Maxorat dars</option>
                        </select>
                    </div>
...
{{--                    </div>--}}
                      ...
                      <button class="btn btn-primary" wire:click.prevent="storeorupdate()">Saqlash</button>
