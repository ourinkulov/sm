<div wire:ignore.self class="modal fade" id="materialniuchirish" tabindex="-1" role="dialog" aria-labelledby="materialniuchirish" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="materialniuchirish">Materialni o'chirish</h5>
