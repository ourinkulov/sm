<div wire:ignore.self class="modal fade bd-example-modal-lg" id="maqolanitaxrirlash" tabindex="-1" role="dialog" aria-labelledby="maqolanitaxrirlash" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="maqolanitaxrirlash">Maqolani tasdiqlash</h5>
