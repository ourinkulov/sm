            ...
            <div class="col-md-2">
                <div class="card shadow p-3 mb-5 bg-white rounded" style="border-radius: 2%; border-color: white">
                    @if (is_null($userprofiles->profileimage))
                        <img src="{{asset('storage/profileimages/1633326373_icons8-expert-128.png')}}" class="card-img-top" alt="..." style="height: 267px; !important;">
                    @else
                        <img src="{{asset('storage/profileimages/'.$userprofiles->profileimage)}}" class="card-img-top" alt="..." style="height: 267px; !important;">
                    @endif
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-left m-0 ml-0 pl-0">
                                    <span style="font-size: 16px; " class=" badge badge-pill badge-warning badge-counter">{{$val1->rey1}}</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-hover table-responsive-lg " style="border: none">
                                        ...
                                        <tr><td class="text-center" style="background-color: rgba(187,89,167,0.37); border-radius: 16px">
                                                <img src="{{asset('year.svg')}}" width="36px" alt=""></td><td>Amaliy ish tajribasi:</td><td>{{$userprofiles->ait}}</td></tr>
