<div wire:ignore.self class="modal fade" id="dissertatsiyaniuchirish" tabindex="-1" role="dialog" aria-labelledby="dissertatsiyaniuchirish" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="maqolaniochirish">Dissertatsiyani o'chirish</h5>
