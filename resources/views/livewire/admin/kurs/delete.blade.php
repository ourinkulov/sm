<div wire:ignore.self class="modal fade" id="kursdelete" tabindex="-1" role="dialog" aria-labelledby="loyihadelete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="langdelete">Til bilish darajasini o'chirish</h5>
