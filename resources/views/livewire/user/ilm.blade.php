<div wire:ignore.self class="modal fade bd-example-modal-lg" id="userprilm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ilmiy unvon ma'lumotlarini kiritish</h5>
...
{{--                    </div>--}}
                    ...
                    <button class="btn btn-primary" wire:click.prevent="userilm()">Saqlash</button>
