<div wire:ignore.self class="modal fade bd-example-modal-lg" id="malakakiritish" tabindex="-1" role="dialog" aria-labelledby="patentkiritish" aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="malakakiritish">Malaka oshirish ma'lumotlarini qo'shish</h5>
