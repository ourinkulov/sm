...
<head>
    ...
    <style>
        .table-fon {font-size: 18px; font-weight: bolder; color: rgb(255, 255, 255);}
        .card_text {color: rgba(48, 94, 180, 0.89); font-size: 22px; font-weight: bolder;}
        .card_text2 {color: rgba(79, 73, 73, 0.8); font-size: 14px; font-weight: bolder; margin-top: 0}
        .card-title{margin-bottom: 0px !important;}
        .bg-success {background-color: rgba(44,140,71,0.75)!important;}
    </style>
...
{{--                    <h6 class="collapse-header">Ilmiy unvon:</h6>--}}
                    <a class="collapse-item" href="{{route('kafedra.addTeacher')}}">O'qituvchilar ro'yxati</a>
{{--                    <h6 class="collapse-header">Ilmiy unvon:</h6>--}}
...
{{--                <div class="py-2 bg-white rounded collapse-inner">--}}
{{--                    <a class="collapse-item" href="{{route('kafedra.darskafedra')}}">Darslar</a>--}}
