...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/kafedra/dashboard')}}">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas fa-window-restore"></i>
            </div>
            <div class="mx-3 sidebar-brand-text">MONITORING  <sup>2</sup></div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{url('/kafedra/dashboard')}}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <span>Ilmiy daraja va unvonlar</span>
            </a>
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                    {{--                    <h6 class="collapse-header">Ilmiy unvon:</h6>--}}
                    <a class="collapse-item" href="{{route('ilmiy.ilmiydaraja')}}"><span>Ilmiy darajalarni tasdiqlash</span></a>
                    <a class="collapse-item" href="{{route('ilmiy.ilmiyunvon')}}"><span>Ilmiy unvonni tasdiqlash</span></a>
                    {{--                    <h6 class="collapse-header">Ilmiy unvon:</h6>--}}
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                    <a class="collapse-item" href="{{route('ilmiy.professors')}}">Professor</a>
                    <a class="collapse-item" href="{{route('ilmiy.dotsents')}}">Dotsent</a>
                    <a class="collapse-item" href="{{route('ilmiy.dsc')}}">DSc</a>
                    <a class="collapse-item" href="{{route('ilmiy.phd')}}">PhD</a>
                    <a class="collapse-item" href="{{route('ilmiy.idiume')}}">Mavjud emas</a>




                    {{--                    <a class="collapse-item" href="">Dissertatsiya</a>--}}
...
<script  type="text/javascript">
    window.livewire.on('ilmiydarajatasdiqlandi', () => {
        $('#ilmiydarajanitasdiqlash').modal('hide');
    });
    window.livewire.on('ilmiyunvontasdiqlandi', () => {
        $('#ilmiyunvonnitasdiqlash').modal('hide');
    });
    window.livewire.on('ilmiyunvondeleted', () => {
        $('#ilmiyunvondelete').modal('hide');
    });
</script>
...
<script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: '2021',
                data: [1, 3, 3, 5, 2, 3,6,8,7,8,10,12],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    // 'rgba(54, 162, 235, 0.2)',
                    // 'rgba(255, 206, 86, 0.2)',
...
<script>
    ...
    var myChart = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: ['Professor', 'Dotsent', 'Mavjud emas'],
            datasets: [{
                label: '# of Votes',
                data: [12, 19, 3],
                backgroundColor: [
